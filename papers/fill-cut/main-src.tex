...
Melli\`es and Tabareau introduced tensor logic as a means of
...
\begin{definition}
  ...
  \]
\end{definition}
The most basic form of tensor logic is called multiplicative tensorial
...
\begin{proof}
  ...
  \end{center}
\end{proof}
Replacing $E$ in the previous result with $\perp$ yields the
...
\begin{proof}
  ...
  the unit of par\footnote{We give a full proof using the previous result in the formalization see the file \url{https://github.com/heades/cut-fill-agda/blob/master/FullLinCat.agda}.}.
\end{proof}
