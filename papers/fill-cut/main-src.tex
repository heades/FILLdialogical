...
\begin{proof}
  \begin{paper}
    ...
    see that companion report \cite{Eades:2015}\footnote{This proof
      ...
      \url{https://github.com/heades/cut-fill-agda/blob/master/Dial2Sets.agda}}. First,
