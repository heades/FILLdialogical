...
\begin{report}
  ...
  \item Given a coalgebra morphism, $f$, between free coalgebras
    $(!A,\delta_A)$ and $(!B,\delta_B)$ it must be the case that $f$ is
    also a comonoid morphism, i.e. the following diagram must commute:
    \begin{center}
      \begin{math}
        \bfig
