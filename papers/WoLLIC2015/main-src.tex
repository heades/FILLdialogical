...
symmetric monodial categories.  There are a number of $\alpha$,
...
linear logic with par, or ii. as a restricted from classical linear
...
\item[Case:] principle formula vs. principle formula: tensor.
The proof 
\begin{center} 
    \begin{math}
    $$\mprset{flushleft}
...
\item[Case:] principle formula vs. principle formula: par.
The proof
\begin{center}
  \scriptsize
    \begin{math}    
...
\end{report}
  ...
  \item[Case:] principle formula vs. principle formula: implication.
The proof
\begin{center}
  \scriptsize
  \begin{math}
...
\begin{report}
\item[Case:] principle formula vs. principle formula: tensor unit.
    The proof
\begin{center}
  \begin{math}
    $$\mprset{flushleft}
...
\item[Case:] principle formula vs. principle formula: par unit.
  The proof
\begin{center}
  \begin{math}
    $$\mprset{flushleft}
