...
\begin{definition}
  ...
  $(\id_U,\pi_2) : A \to A$.  The composition of the maps
...
see page 15 of \cite{Benton:1994}.  We now have the following result:
...
\begin{proof}
  ...
  \begin{center}
    ...
    \item (Section 4.5, on page 76 of \cite{dePaiva:1988}). The
      ...
      \begin{itemize}
      \item Objects. Suppose $A = (U,X,\alpha) \in \obj{\dial}$.
        Then we set $!A = (U,U \Rightarrow X^*, !\alpha)$, where $(u,f)
        \in !\alpha$ if and only if $(u,f(u)) \in \alpha$. 
