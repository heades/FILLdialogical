...
\begin{abstract}
  ...
  cut-elimination by Bierman, but Bellin proposed a change to the
  definition of FILL in the hope to regain cut-elimination.  In this
  note we adopt Bellin's proposed change and give a direct proof of
  cut-elimination.  Then we show that a categorical model of FILL in
  the basic dialectica category is also a LNL model of Benton and a
...
\keywords{full intuitionistic linear logic, \mbox classical linear
  logic, \mbox dialectica category, \mbox cut-elimination, \mbox
  tensorial logic, \mbox linear/non-linear models, \mbox categorical
  model, \mbox proof theory, \mbox par}
