...
being discharged, $x$, is potentially free in only one term annotating
a conclusion.  Unfortunately, this formalization did not enjoy
cut-elimination either.
...
(Lemma~\ref{lemma:monoidal-fact1}).  Thus, any model of FILL can be
seen as a model of multiplicative tensorial logic.  In addition, we
show that $\dial$ is not only a model of multiplicative tensorial
logic, but a model of full tensorial logic.
