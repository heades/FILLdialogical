...
derivations we can see that $[[z nin FV(L1)]]$, and thus, $[[L1 = [\x.t/x]L1]]$.  Therefore, all terms are equivalent between the previous two derivations, and 
hence, the two proofs are equivalent.
% subsubsection implication (end)
...
\begin{center}
  ...
  \end{math}
\end{center}
Clearly, $[[ [o/x]. = .]]$, hence, the two proofs above are equivalent.
